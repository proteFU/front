...
const songs: Song[] = [
  {
    ...
    lyrics: [
      ...
      { text: "우린 어떤 때보다도 ain't no diggity", start: 10 },
      { text: "What goes around, some comes around 안 들려, 몰라", start: 15 },
      { text: "Look at me now 느낌이 와, 다르지 너완", start: 20 },
      { text: "I'm your wannabe 입 밖으론 못 뱉지", start: 25 },
      { text: "Runnin', runnin', runnin', runnin'", start: 30 },
      { text: "USomething's comin', comin', comin' (ah)", start: 30 },
      { text: "Siren, siren, siren, siren, siren", start: 30 },
      { text: "On and on and on (and)", start: 30 },
    ],
    src: "BadNews.mp3",
  },
  {
